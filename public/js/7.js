...
var _coefficient = __webpack_require__(389);
...
var _CreateCoefficient = __webpack_require__(390);

var _CreateCoefficient2 = _interopRequireDefault(_CreateCoefficient);

var _UpdateCoefficient = __webpack_require__(393);
...
exports.default = {
    ...
    methods: {
        editCoefficient: function editCoefficient(id) {
            var _this = this;
                    ...
                    while (1) {
                        switch (_context.prev = _context.next) {
                            case 0:
                                _context.prev = 0;
                                _context.next = 3;
                                return _this.$store.dispatch('admin/getCoefficient', id);

                            case 3:
                                _this.modalsIsShowUpdateCoefficient = true;
                                _context.next = 9;
                                break;
                    ...
                    while (1) {
                        switch (_context2.prev = _context2.next) {
                            ...
                            case 2:
                                ...
                                _context2.prev = 4;
                                _context2.next = 7;
                                return _this2.$store.dispatch('admin/destroyCoefficient', id);
    ...
    data: function data() {
        return {
            fields: [{
                ...
                name: 'major.name',
                sortField: 'major.name',
                title: this.$t('translation.majorNameTable'),
                titleClass: 'text-left',
                dataClass: 'text-left'
            }, {
                name: 'coefficient',
                        ...
                        switch (_context.prev = _context.next) {
                            ...
                            case 2:
                                ...
                                return _this.$store.dispatch('admin/createCoefficient', {
                                    major_id: _this.coefficientMajorId.id,
                                    name: _this.coefficientName,
                                    coefficient: Number(_this.coefficientCoefficient)
                                });
...
exports.default = {
    ...
    methods: {
        ...
        saveEditCoefficient: function saveEditCoefficient() {
            var _this = this;
      ...
      ? _c("div", { staticClass: "modal__wrap" }, [
          _c("div", { staticClass: "modal__content modal__md" }, [
            _c("h4", { staticClass: "modal__head" }, [
              _vm._v(
                "\n                " +
                  _vm._s(_vm.$t("translation.editCoefficient")) +
                  "\n            "
              )
            ]),
            _vm._v(" "),
              ...
              [
                ...
                _c(
                  "button",
                  {
                    staticClass: "btn btn-md btn-success mt-4",
                    attrs: { type: "button" },
                    on: { click: _vm.saveEditCoefficient }
                  },
                  [
                    _vm._v(
                      "\n                    " +
            ...
            [
              _c("vuetable", {
                ...
                attrs: {
                  "api-url":
                    _vm.constants.URL +
                    "/api/tutor-admin/subjects-coefficients",
                  fields: _vm.fields,
                  "pagination-path": "",
                  css: _vm.css.table,
                  "data-path": "data.data",
                      ...
                      return [
                        _c(
                          "a",
                          {
                            ...
                            on: {
                              click: function($event) {
                                _vm.editCoefficient(props.rowData.id)
                              }
                            }
                          },
                          [
                        ...
                        _c(
                          "button",
                          {
                            ...
                            on: {
                              click: function($event) {
                                _vm.destroyCoefficient(props.rowData.id)
                              }
                            }
                          },
